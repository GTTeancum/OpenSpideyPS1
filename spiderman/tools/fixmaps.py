...
MAIN_TEXT_LIMIT = 0x800917A0
MAIN_ENTRY = 0x8008739C        # pc0 from the PS-X EXE header
...
def main():
    ...
    mods = []
    exe = open(os.path.join(root, 'extracted', 'SLUS_008.75'), 'rb').read()
    mods.append(Module('main', exe[0x800:0x800 + 0xB6800], 0x80010000, MAIN_TEXT_LIMIT))
