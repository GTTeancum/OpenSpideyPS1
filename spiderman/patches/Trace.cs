...
/// <summary>
/// Temporary instrumentation hooks, wired by address from config/spiderman.json.
/// Enabled only when SPIDEY_TRACE is set.
/// </summary>
public static class Trace
{
    static readonly bool On = !string.IsNullOrEmpty(Environment.GetEnvironmentVariable("SPIDEY_TRACE"));
